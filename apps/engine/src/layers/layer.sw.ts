...
import { ProjectBrowserAlarms, type ProjectBrowserAlarms as ProjectBrowserAlarmsType } from '../project/project-browser-alarms.sw.js'
import { ProjectBrowserContextMenus, type ProjectBrowserContextMenus as ProjectBrowserContextMenusType } from '../project/project-browser-context-menus.sw.js'
import { ProjectBrowserDeclarativeNetRequest, type ProjectBrowserDeclarativeNetRequest as ProjectBrowserDeclarativeNetRequestType } from '../project/project-browser-declarative-net-request.sw.js'
import { ProjectBrowserNotifications, type ProjectBrowserNotifications as ProjectBrowserNotificationsType } from '../project/project-browser-notifications.sw.js'
import { ProjectBrowserPermissions, type ProjectBrowserPermissions as ProjectBrowserPermissionsType } from '../project/project-browser-permissions.sw.js'
import { ProjectBrowserStorageArea, type ProjectBrowserStorageArea as ProjectBrowserStorageAreaType } from '../project/project-browser-storage-area.sw.js'
import { ProjectBrowserStorage, type ProjectBrowserStorage as ProjectBrowserStorageType } from '../project/project-browser-storage.sw.js'
import { ProjectBrowser, type ProjectBrowser as ProjectBrowserType } from '../project/project-browser.sw.js'
import { ProjectTarget, type ProjectTarget as ProjectTargetType } from '../project/project-target.sw.js'
import { Project, type Project as ProjectType } from '../project/project.sw.js'
