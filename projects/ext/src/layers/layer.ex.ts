...
import { KitBrowserApi, type KitBrowserApi as KitBrowserApiType } from '../app/kit/kit-browser-api.ex.ts'
...
declare global {
  ...
  interface $Ex {
    ...
    Dev: typeof Dev
    Idb: typeof Idb
    KitBrowserApi: typeof KitBrowserApi
  ...
  namespace $ex {
    ...
    export type KitBrowserApi = KitBrowserApiType
